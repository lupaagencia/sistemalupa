...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-11-2020 a las 10:42:20
...
(1, 1, '12366546', 'Caja l14', '569.00', 123, 'fsdfaasd', 1, '2020-11-05 22:54:41', '2020-11-05 22:54:41');
...
(16, 'Jurídica', NULL, NULL, NULL, 'Juan David Gómez', NULL, NULL);
...
(8, 8, 8, 'Papel', 'Cartón Kraft calibre 48', 'grs', '681.00', '0.00', '1', '2020-11-05 14:26:19', '2020-11-06 17:46:59'),
...
(88, 25, 25, 'placha', 'Plancha Octavo 25,5x38', 'unidad', '6000.00', '0.00', '1', '2020-11-14 05:38:34', '2020-11-14 05:38:34'),
(89, 25, 25, 'placha', 'Plancha de doble carta 28x46cm', 'unidad', '7000.00', '0.00', '1', '2020-11-14 05:39:13', '2020-11-14 05:39:13'),
(90, 25, 25, 'placha', 'Plancha ABD 360 47,5 c 27,5', 'unidad', '7000.00', '0.00', '1', '2020-11-14 05:39:50', '2020-11-14 05:39:50'),
(91, 25, 25, 'placha', 'Plancha de cuarto 52x40', 'unidad', '8500.00', '0.00', '1', '2020-11-14 05:40:38', '2020-11-14 05:40:38'),
(92, 25, 25, 'placha', 'Plancha de Cuarto Mayor 55x65', 'unidad', '13000.00', '0.00', '1', '2020-11-14 05:41:31', '2020-11-14 05:41:31'),
(93, 25, 25, 'placha', 'Plancha solna 125 64,5x50,8', 'unidad', '13000.00', '0.00', '1', '2020-11-14 05:42:12', '2020-11-14 05:42:12'),
(94, 25, 25, 'placha', 'Plancha de speedmaster 52,5x45,9', 'unidad', '10000.00', '0.00', '1', '2020-11-14 05:42:35', '2020-11-14 05:44:52'),
(95, 25, 25, 'placha', 'Plancha de Medio pliego', 'unidad', '20000.00', '0.00', '1', '2020-11-14 05:43:13', '2020-11-14 05:43:13'),
(96, 25, 25, 'placha', 'Plancha Harris 82,5x69,2', 'unidad', '35000.00', '0.00', '1', '2020-11-14 05:43:49', '2020-11-14 05:43:49'),
(97, 25, 25, 'placha', 'Plancha de pliego', 'unidad', '45000.00', '0.00', '1', '2020-11-14 05:44:08', '2020-11-14 05:44:08'),
...
(103, 26, 26, 'Papel', 'Bond 75 grs', 'pliego', '227.00', '0.00', '1', '2020-11-18 05:54:11', '2020-11-18 05:54:11'),
...
CREATE TABLE `ordentrabajos` (
  ...
  `ancho_material` decimal(20,2) NOT NULL,
  `largo_material` decimal(20,2) NOT NULL,
  `areas_impresas` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `tipo_impresion` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `colores_impresion` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `unidad_medida` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `detalles_diseno` varchar(400) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Carpeta_cliente` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `observaciones` varchar(400) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(24, 'La selecta', 'DNI', NULL, 'Carrera 31 #9c70', NULL, 'lupaproyectos@gmail.com', '2020-11-09 04:40:29', '2020-11-09 05:13:38'),
(25, 'CTP MAX FUXION', 'CC', NULL, 'Carrera 3 No. 20-01', '8816070', 'maxfuxionctp@gmail.com', '2020-11-14 05:37:43', '2020-11-14 05:37:43'),
(26, 'Servipapeles', 'RUC', NULL, 'Cra 5 # 17-', NULL, NULL, '2020-11-18 05:53:18', '2020-11-18 05:53:18'),
...
(2, 'julian', '$2y$10$2yoQ63PFFAFPgcuJ2eCYIOYIJ3Snhj068IOEld/nPcDAs7miVYsie', 1, 1, NULL);
...
ALTER TABLE `costos`
  ...
  ADD CONSTRAINT `costos_idorden_foreign` FOREIGN KEY (`idorden`) REFERENCES `ordentrabajos` (`id`);

--
-- Filtros para la tabla `detalletrabajos`
--
ALTER TABLE `detalletrabajos`
  ADD CONSTRAINT `detalletrabajos_idorden_foreign` FOREIGN KEY (`idorden`) REFERENCES `costois` (`id`);
...
--
ALTER TABLE `ordentrabajos`
  ADD CONSTRAINT `ordentrabajos_ibfk_2` FOREIGN KEY (`idarticulo`) REFERENCES `articulos` (`id`);
