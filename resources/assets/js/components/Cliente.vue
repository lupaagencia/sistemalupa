                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" v-model="departamento" class="form-control" placeholder="Departamento">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="email-input">País</label>
                                    <div class="col-md-9">
                                        <input type="text" v-model="pais" class="form-control" placeholder="País">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="telefono-input">Teléfono</label>
                                    <div class="col-md-9">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="input">Teléfono de Contacto</label>
                                    <div class="col-md-9">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="email" v-model="email_contacto" class="form-control" placeholder="Email de contacto">
                                    </div>
                                </div>
