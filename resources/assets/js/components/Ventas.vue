                ...
                <div class="card">
                                ...
                                <div class="col-md-12">
                                    <div class="col-xl-12">
                                        <div class="input-group">
                                            <input type="text" v-model="buscare" @keyup="listarOrdenesVentas(1,`%${buscare}%`,'like','personas.nombre')"  placeholder="Empresa">
                                            <input type="text" v-model="buscarc" @keyup="listarOrdenesVentas(1,`%${buscarc}%`,'like','clientes.contacto')"  placeholder="Contacto">
                                            <input type="text" v-model="buscarv" @keyup="listarOrdenesVentas(1,`%${buscarv}%`,'like','ordentrabajos.total')"  placeholder="Valor orden">
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button @click="filtrarFechaVentas()" type="button" class="btn btn-primary">Aplicar</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>  
                                                <select @change="filtrarFechaVentas()" v-model="filtroFecha">
                                ...
                                <table class="table table-bordered table-striped table-sm">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th @click="ordenar('contacto')">Abono<i v-if="ordenarFlecha" class="fa fa-arrow-up"></i><i v-else class="fa fa-arrow-down"></i></th>
                                            <th @click="ordenar('telefono_contacto')">Saldo <i v-if="ordenarFlecha" class="fa fa-arrow-up"></i><i v-else class="fa fa-arrow-down"></i></th>
                                            <th @click="ordenar('carpeta_cliente')">Total <i v-if="ordenarFlecha" class="fa fa-arrow-up"></i><i v-else class="fa fa-arrow-down"></i></th>
                                    ...
                                    <tbody v-if="arrayOrdenes.length">
                                        ...
                                        <tr><td colspan="5"></td><td><strong>Total Abonos ${{forNum(totalAbonos)}}</strong></td><td><strong>Total Cartera: ${{forNum(totalCartera)}}</strong></td><td><strong> Venta: ${{forNum(totalVenta)}}</strong></td></tr>
                                    </tbody>
                                    <tbody v-else>
                                        <tr>
                                            <td colspan="5">
                    ...
                    <template v-else-if="listado===2">
                        <div class="botones_vieworden">
                            <button class="btn btn-primary" @click="ocultarDetalle">Volver al listado de ventas</button>
                            <button class="btn btn-warning" @click="imprimirOrden">Imprimir</button>
                        </div>
...
<script>
    ...
    export default {
        ...
        computed:{
            ...
            totalCartera(){
                var resultado=0
                console.log(this.arrayOrdenes.length)
        ...
        methods : {
            ...
            cambiarPagina(page,buscar,criterio){
                ...
                me.listarVentas(page,buscar,'like',criterio);
            },
