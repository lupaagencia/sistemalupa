<template>
    <div class="mt-5" v-if="product && !closed">
        <div class="">
            <font-awesome-icon icon="chevron-right" class="" @click="closed = true" 
            />
        <img :src="src()" style="height:290px"  class="" alt="">
        <div class=" p-3">
            <h2>{{product.nombre}} <small><span class="badge badge-secondary">{{product.precio_venta }}</span></small></h2> 

            <div class="row p-4" v-if="true">
                <p>
                    m dolor sit amet, consectetur adipisicing elit. Est nesciunt, porro deserunt voluptatum rem excepturi dicta unde corporis sint magnam nisi repellat dolor accusantium nihil quis eligendi cupiditate autem corrupti?
                </p>
                <div class="col">
